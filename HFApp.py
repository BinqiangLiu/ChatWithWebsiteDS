...
with st.sidebar:
    ...
    st.write("Note & Disclaimer:\n\nThis app is provided on open source framework and is for information purpose only. NO guarantee is offered regarding information accuracy.\n\nNO liability could be claimed against whoever associated with this app in any manner. User should consult a qualified legal professional for legal advice.")
